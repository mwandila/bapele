...
//       <header className="bg-blue-600 bg-opacity-90 text-white py-4">
...
const HomePage = () => {
  const [showModal, setShowModal] = useState(false);
  const [modalContent, setModalContent] = useState<"signup" | "borrower">();

  const openModal = (content: "signup" | "borrower") => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="text-white-600 px-6 py-3 rounded-full font-semibold hover:bg-blue-600 transition duration-300"
            >
              Become a Lender
            </button>
            <button
              className="text-white-600 px-6 py-3 rounded-full font-semibold hover:bg-pink-900 transition duration-300 relative"
              onClick={() => openModal("borrower")}
            >
              Become a Borrower
              <svg
                className="absolute right-2 top-2"
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white shadow-lg p-8 w-[80vh] h-[80vh] rounded-lg relative">
            <button
